...
package body V2P.Settings is
   ...
   function Get_Deactivated_User_Name return String is
   begin
      return Conf.Get_Value (Deactivated_User_Name);
   end Get_Deactivated_User_Name;
   ...
   function Max_Vote_Per_User return Positive is
   begin
      return Conf.Get_Value (Max_Vote_Per_User);
   end Max_Vote_Per_User;
